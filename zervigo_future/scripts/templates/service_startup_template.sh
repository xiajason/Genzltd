...
# 微服务启动脚本模板
# 使用方法：复制此文件并修改SERVICE_NAME和SERVICE_PORT变量

set -e

# ==================== 配置区域 ====================
# 请根据具体服务修改以下配置
SERVICE_NAME="your-service-name"        # 服务名称
SERVICE_PORT="8080"                     # 服务端口
SERVICE_DIR="backend/cmd/your-service"  # 服务目录
SERVICE_BINARY="your-service"           # 服务可执行文件名
