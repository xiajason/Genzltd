...
create_database_structures() {
    ...
    # 复制脚本到容器
    docker cp blockchain_database_structure_executor.py blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_mysql_database_structure.sql blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_postgresql_database_structure.sql blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_sqlite_database_structure.py blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_redis_database_structure.py blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_neo4j_database_structure.py blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_elasticsearch_database_structure.py blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_weaviate_database_structure.py blockchain-sqlite-manager:/app/scripts/
    docker cp blockchain_database_verification_script.py blockchain-sqlite-manager:/app/scripts/
    
    # 执行数据库结构创建
    docker exec blockchain-sqlite-manager python3 /app/scripts/blockchain_database_structure_executor.py
